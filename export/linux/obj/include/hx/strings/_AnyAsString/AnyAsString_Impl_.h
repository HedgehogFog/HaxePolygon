...
class HXCPP_CLASS_ATTRIBUTES AnyAsString_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< AnyAsString_Impl__obj > __new() {
			hx::ObjectPtr< AnyAsString_Impl__obj > __this = new AnyAsString_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< AnyAsString_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("AnyAsString_Impl_","\x2f","\xb0","\x62","\x7c"); }
