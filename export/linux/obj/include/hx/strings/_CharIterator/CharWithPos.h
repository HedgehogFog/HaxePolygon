...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_4c2c1e05a45d1a03_201_new)
...
class HXCPP_CLASS_ATTRIBUTES CharWithPos_obj : public  ::hx::strings::CharPos_obj
{
	...
	public:
		...
		hx::ObjectPtr< CharWithPos_obj > __new(int _hx_char,int index,int line,int col) {
			hx::ObjectPtr< CharWithPos_obj > __this = new CharWithPos_obj();
			__this->__construct(_hx_char,index,line,col);
			return __this;
		}

		static hx::ObjectPtr< CharWithPos_obj > __alloc(hx::Ctx *_hx_ctx,int _hx_char,int index,int line,int col) {
...
HXLINE( 202)		__this->super::__construct(index,line,col);
HXLINE( 203)		( ( ::hx::strings::_CharIterator::CharWithPos)(__this) )->_hx_char = _hx_char;
            	}
		...
		::String __ToString() const { return HX_HCSTRING("CharWithPos","\xd8","\x2e","\x21","\x6b"); }
