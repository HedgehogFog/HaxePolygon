...
class HXCPP_CLASS_ATTRIBUTES Either3_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Either3_Impl__obj > __new() {
			hx::ObjectPtr< Either3_Impl__obj > __this = new Either3_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Either3_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("Either3_Impl_","\x4e","\x3a","\x74","\x8e"); }
