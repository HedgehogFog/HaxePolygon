...
class HXCPP_CLASS_ATTRIBUTES RingBuffer_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< RingBuffer_Impl__obj > __new() {
			hx::ObjectPtr< RingBuffer_Impl__obj > __this = new RingBuffer_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< RingBuffer_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("RingBuffer_Impl_","\x90","\x09","\x6a","\x84"); }
