...
class HXCPP_CLASS_ATTRIBUTES Either2_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Either2_Impl__obj > __new() {
			hx::ObjectPtr< Either2_Impl__obj > __this = new Either2_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Either2_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("Either2_Impl_","\x8d","\xc3","\xde","\x64"); }
