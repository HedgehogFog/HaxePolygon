...
class HXCPP_CLASS_ATTRIBUTES OneOrMany_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< OneOrMany_Impl__obj > __new() {
			hx::ObjectPtr< OneOrMany_Impl__obj > __this = new OneOrMany_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< OneOrMany_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("OneOrMany_Impl_","\xe8","\x78","\xea","\x1d"); }
