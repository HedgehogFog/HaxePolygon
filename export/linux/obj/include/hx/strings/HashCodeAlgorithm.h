...
class HashCodeAlgorithm_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("hx.strings.HashCodeAlgorithm","\xea","\xe4","\xff","\x74"); }
		::String __ToString() const { return HX_HCSTRING("HashCodeAlgorithm.","\xfa","\xb8","\x4c","\xb6") + _hx_tag; }
