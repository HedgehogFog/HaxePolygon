...
HX_DEFINE_STACK_FRAME(_hx_pos_312e3f7dfa8ca2c7_7_new,"Preloader","new",0x90324848,"Preloader.new","Preloader.hx",7,0xc73f5828)
...
Float MinDisplayTime = __o_MinDisplayTime.Default(0);
            	HX_STACKFRAME(&_hx_pos_312e3f7dfa8ca2c7_7_new)
HXLINE(   8)		super::__construct(MinDisplayTime,AllowedURLs);
HXLINE(   9)		this->onLoaded();
            	}
