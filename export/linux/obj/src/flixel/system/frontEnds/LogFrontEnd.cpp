...
HXLINE(  58)			this->_standardTraceFunction(Data,hx::SourceInfo(HX_("LogFrontEnd.hx",48,a9,ee,6c),58,HX_("flixel.system.frontEnds.LogFrontEnd",5c,bd,97,07),HX_("advanced",a2,69,7b,3b)));
HXLINE(  59)			return;
            		}
