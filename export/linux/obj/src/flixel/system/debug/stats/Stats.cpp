...
HXLINE(  98)		super::__construct(HX_("Stats",ff,e5,38,17), ::flixel::_hx_system::debug::GraphicStats_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()),(int)0,(int)0,false,null(),null(),null());
