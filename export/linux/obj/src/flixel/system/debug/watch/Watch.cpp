...
HXLINE(  25)		super::__construct(HX_("Watch",2f,86,52,58), ::flixel::_hx_system::debug::GraphicWatch_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()),(int)0,(int)0,true,null(),closable,null());
