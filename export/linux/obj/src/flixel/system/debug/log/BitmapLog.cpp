...
HXLINE(  53)		super::__construct(HX_("BitmapLog",b5,3b,ae,68), ::flixel::_hx_system::debug::GraphicBitmapLog_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()),null(),null(),null(),null(),null(),null());
