...
HXLINE(  24)		super::__construct(HX_("Log",64,0c,3a,00), ::flixel::_hx_system::debug::GraphicLog_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()),null(),null(),null(),null(),null(),null());
