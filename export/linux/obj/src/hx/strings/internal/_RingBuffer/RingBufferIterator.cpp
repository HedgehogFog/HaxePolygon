...
HX_DEFINE_STACK_FRAME(_hx_pos_288cb02e11953f11_104_new,"hx.strings.internal._RingBuffer.RingBufferIterator","new",0x0e9dc9b6,"hx.strings.internal._RingBuffer.RingBufferIterator.new","hx/strings/internal/RingBuffer.hx",104,0xc9fcbcc8)
...
void RingBufferIterator_obj::__construct( ::hx::strings::internal::_RingBuffer::RingBufferImpl buff){
            	HX_STACKFRAME(&_hx_pos_288cb02e11953f11_104_new)
HXLINE( 107)		this->idx = (int)-1;
...
bool RingBufferIterator_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x17433f46;
}

bool RingBufferIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_288cb02e11953f11_116_hasNext)
HXDLIN( 116)		return ((this->idx + (int)1) < this->buff->length);
            	}
...
{
	outFields->push(HX_HCSTRING("buff","\xd3","\x09","\x20","\x41"));
...
static hx::StorageInfo RingBufferIterator_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::hx::strings::internal::_RingBuffer::RingBufferImpl*/ ,(int)offsetof(RingBufferIterator_obj,buff),HX_HCSTRING("buff","\xd3","\x09","\x20","\x41")},
	{hx::fsInt,(int)offsetof(RingBufferIterator_obj,idx),HX_HCSTRING("idx","\x3d","\x04","\x50","\x00")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String RingBufferIterator_obj_sMemberFields[] = {
	HX_HCSTRING("buff","\xd3","\x09","\x20","\x41"),
	HX_HCSTRING("idx","\x3d","\x04","\x50","\x00"),
	HX_HCSTRING("hasNext","\x6d","\xa5","\x46","\x18"),
	HX_HCSTRING("next","\xf3","\x84","\x02","\x49"),
	::String(null()) };

static void RingBufferIterator_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(RingBufferIterator_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void RingBufferIterator_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(RingBufferIterator_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new RingBufferIterator_obj;
	RingBufferIterator_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("hx.strings.internal._RingBuffer.RingBufferIterator","\xc4","\x76","\x65","\x36");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = RingBufferIterator_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = RingBufferIterator_obj_sVisitStatics;
#endif
