...
static void _Either2_obj_sMarkStatics(HX_MARK_PARAMS) {
};

#ifdef HXCPP_VISIT_ALLOCS
static void _Either2_obj_sVisitStatic(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(_Either2_obj::__mClass,"__mClass");
};
#endif
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("hx.strings.internal._Either2._Either2","\x07","\x08","\xe6","\x82"), hx::TCanCast< _Either2_obj >,_Either2_obj_sStaticFields,0,
	&__Create__Either2_obj, &__Create,
	&super::__SGetClass(), &Create_Either2_obj, _Either2_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , _Either2_obj_sVisitStatic
#endif
