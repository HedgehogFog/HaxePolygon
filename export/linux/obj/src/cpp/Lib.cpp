...
HX_LOCAL_STACK_FRAME(_hx_pos_ead2d82c766bb2c1_69_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/share/haxe/std/cpp/Lib.hx",69,0x195878e0)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ead2d82c766bb2c1_76_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/share/haxe/std/cpp/Lib.hx",76,0x195878e0)
HX_LOCAL_STACK_FRAME(_hx_pos_ead2d82c766bb2c1_77_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/share/haxe/std/cpp/Lib.hx",77,0x195878e0)
HX_LOCAL_STACK_FRAME(_hx_pos_ead2d82c766bb2c1_78_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/usr/share/haxe/std/cpp/Lib.hx",78,0x195878e0)
namespace cpp{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Lib_obj,load,return )
 ...
 ::Dynamic Lib_obj::loadLazy(::String lib,::String prim,int nargs){
            	HX_STACKFRAME(&_hx_pos_ead2d82c766bb2c1_69_loadLazy)
HXDLIN(  69)		try {
...
HXLINE(  75)						return  ::Dynamic(new _hx_Closure_3(e));
            					...
            					case (int)4: {
            						...
            						void _hx_run( ::Dynamic _12, ::Dynamic _22, ::Dynamic _31, ::Dynamic _4){
            							HX_STACKFRAME(&_hx_pos_ead2d82c766bb2c1_76_loadLazy)
...
HXLINE(  76)						return  ::Dynamic(new _hx_Closure_4(e));
            					...
            					case (int)5: {
            						...
            						void _hx_run( ::Dynamic _13, ::Dynamic _23, ::Dynamic _32, ::Dynamic _41, ::Dynamic _5){
            							HX_STACKFRAME(&_hx_pos_ead2d82c766bb2c1_77_loadLazy)
...
HXLINE(  77)						return  ::Dynamic(new _hx_Closure_5(e));
            					...
            					default:{
            						...
            						void _hx_run( ::Dynamic _14){
            							HX_STACKFRAME(&_hx_pos_ead2d82c766bb2c1_78_loadLazy)
