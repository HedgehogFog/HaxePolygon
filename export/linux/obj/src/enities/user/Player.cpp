...
HX_DEFINE_STACK_FRAME(_hx_pos_1ff1870756bc1ff7_6_new,"enities.user.Player","new",0xb0e778cb,"enities.user.Player.new","enities/user/Player.hx",6,0x302f00a5)
HX_LOCAL_STACK_FRAME(_hx_pos_1ff1870756bc1ff7_21_update,"enities.user.Player","update",0x86e4b27e,"enities.user.Player.update","enities/user/Player.hx",21,0x302f00a5)
static const int _hx_array_data_ca5ab759_2[] = {
	(int)38,(int)87,
};
static const int _hx_array_data_ca5ab759_3[] = {
	(int)37,(int)65,
};
static const int _hx_array_data_ca5ab759_4[] = {
	(int)39,(int)68,
};
namespace enities{
namespace user{
...
void Player_obj::__construct(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_1ff1870756bc1ff7_6_new)
...
bool Player_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x25a685e0) {
		...
		return inClassId==(int)0x2e105115 || inClassId==(int)0x5ae5afab;
	}
}

void Player_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1ff1870756bc1ff7_21_update)
HXLINE(  22)		this->super::update(elapsed);
HXLINE(  24)		if (::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_ca5ab759_2,2),(int)1)) {
HXLINE(  25)			this->speed = (int)150;
            		}
HXLINE(  28)		if (::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_ca5ab759_3,2),(int)1)) {
HXLINE(  29)			 ::enities::user::Player _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  29)			_hx_tmp->dir = (_hx_tmp->dir - (this->rot * elapsed));
            		}
HXLINE(  32)		if (::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_ca5ab759_4,2),(int)1)) {
HXLINE(  33)			 ::enities::user::Player _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
...
HXLINE(  38)		 ::enities::user::Player _hx_tmp6 = hx::ObjectPtr<OBJ_>(this);
...
hx::ObjectPtr< Player_obj > Player_obj::__alloc(hx::Ctx *_hx_ctx,Float x,Float y) {
	Player_obj *__this = (Player_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Player_obj), true, "enities.user.Player"));
...
void Player_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("enities.user.Player","\x59","\xb7","\x5a","\xca");
